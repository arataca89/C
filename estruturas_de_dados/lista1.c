...
SCHILDT. C Completo e Total. 3a Edição. São Paulo: Makron Books, 1996.
DEITEL;DEITEL. C Como Programar. 6a Edição. São Paulo: Pearson Prentice Hall, 2011.
TANENBAUM;LANGSAM;AUGENSTEIN. Estruturas de Dados Usando C. São Paulo: Pearson Makron Books, 1995.
